...
//    $users = DB::table('users')->get();
    ...
    $users  = DB::table('users')
      ->select(array('testvocabs.user_id', 'users.titleName', 'users.name', 'users.lastname', 'users.name', 'users.nickname', 'users.id', DB::raw('COUNT(testvocabs.user_id) as count')))
    ...
    $users = $users->groupBy('users.titleName')
      ->groupBy('users.name')
...
//    dd($testvocabs);
    ...
    $user = DB::table('users')
      ...
      ->get();
//    dd($user,$testvocabs);
    return view('sentences.show', compact('testvocabs', $testvocabs, 'user', $user));
  }
