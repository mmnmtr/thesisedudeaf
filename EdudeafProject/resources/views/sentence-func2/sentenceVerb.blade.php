                  ...
                  <div class="row">
                    ...
                    <div class="sentence col-md-4">
                      <div class="text-center">
                        ...
                        <div class="fieldSpace">
                          <div id="textfield"></div>
                          <input type="text" id="theinput" value="{{{ $testvocab->verb or '' }}}" class="verbField"
                                 name="verb">
                ...
                <div class="col-md-12" style="padding-bottom:20px; ">
                  <div class="mb-2 box-shadow">
                    <div class="text-center">
                      ...
                      <input type="button" class="button btn-vocabV" value="{{$vocabulary->vocab_word}}" data-id="{{$vocabulary->id}}"/>
                    </div>
                  </div>
                </div>
              @endforeach
