            ...
            @if(count($exercises) > 0)
              @foreach($exercises as $exercise)
                ...
                <tr>
                  ...
                  <td width="25%" >{{$exercise->exercise_name}}</td>
                  <td width="30%" >{{$exercise->exerciseType_name}}</td>
                  ...
                  <td width="30%" style="text-align: center"><a href="/admin/exercises/{{$exercise->id}}"><button class="btn btn-sentenceMore"><i class="fas fa-eye"></i> ดูคะแนน</button></a></td>
                </tr>
                </tbody>
              @endforeach
            @else
